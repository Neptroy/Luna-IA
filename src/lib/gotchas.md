...
| room_id inválido | OpenAI usando índices | Validar longitud > 10 y pasar UUID |
| Error en script de recordatorios | `TWILIO_FROM_NUMBER` nulo | Verificar formato `whatsapp:+...` en secrets |
```